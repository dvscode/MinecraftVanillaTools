...
# add command on tap
data merge block ~-0.5 ~1.5 ~1.5 {Text1:"{\"text\":\"Public Teleport System\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function dvs:tp_activate\"},\"color\":\"cyan\"}",Text2:"{\"text\":\"1 LVL\",\"color\":\"green\"}",Text3:"",Text4:"{\"text\":\"Tap to activate\",\"color\":\"blue\"}"}

# add east sign
execute align x align z run setblock ~1.5 ~1.5 ~-1.5 minecraft:wall_sign[facing=east] replace

# add command on tap
execute align x align z run data merge block ~1.5 ~1.5 ~-1.5 {Text1:"{\"text\":\"Public Teleport System\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"function dvs:tp_activate\"},\"color\":\"cyan\"}",Text2:"{\"text\":\"1 LVL\",\"color\":\"green\"}",Text3:"",Text4:"{\"text\":\"Tap to activate\",\"color\":\"blue\"}"}
