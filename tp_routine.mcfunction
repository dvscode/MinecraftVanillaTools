...
execute as @p at @a[distance=..3,team=!admin] if score @p[distance=..3] xp matches 0 if block ~ ~-1 ~ minecraft:diamond_block run tellraw @p {"text":"Can't teleport, not enough xp","color":"red"}
